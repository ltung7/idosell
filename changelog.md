...
## [0.4.52] - 2026-08-11
### Fixed 
- Fixed false infinite loop error


## [0.4.51] - 2026-08-06
### Added
- Added first() method that returns first element or undefined if not elements found
### Fixed
- Fixed any requirement when all variables were present
  

## [0.4.50] - 2026-07-03
### Added
- Running multiple requests in parallel using Promise.all and joining responses
