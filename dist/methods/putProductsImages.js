...
export default (object) => {
    ...
    object.custom = {
        ...
        addImage: (source, priority = null) => { const index = object.appendable.index; if (!object.n) object.n = {}; if (!object.n[index]) object.n[index] = 1; if (priority) object.n[index] = priority; const params = {}; const arr = object.params.productsImages; const node = { productImageNumber: object.n[index]++, productImageSource: source }; params.productImages = arr[arr.length - 1].productImages ?? []; params.productImages.push(node); return params; },
