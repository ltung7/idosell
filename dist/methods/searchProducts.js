...
export default (object) => {
    ...
    object.custom = {
        ...
        inStock: (stockIds = true) => { const productAvailableInStocks = { productIsAvailableInStocks: stockIds === false ? "n" : "y" }; if (stockIds) {
            if (typeof stockIds === "number")
                stockIds = [stockIds];
            if (Array.isArray(stockIds))
                productAvailableInStocks.productAvailableInStocksIds = stockIds;
