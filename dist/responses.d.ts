...
export type ProductIdentResponse = {
...
export type BooleanStatusResponse = {
    /** @description Confirmation of completed operation. */
    status: boolean;
};

export type GetClientsBalanceResponse = {
    clientsBalance: {
...
export type SearchClientsGiftcardsResponse = {
    ...
    result: {
        ...
        /** @description Error code. List of error codes: "0" - Operation was successful, "1" - Login failure: invalid username or key, "111" - Error occurred when retrieving gift card data */
        faultCode: number;
        /** @description Error description. */
        faultString: string;
    }[];
...
export type GetClientsGiftcardsTypesResponse = {
    /** @description List all types of gift cards defined in the administration panel */
    giftCardsTypes: {
        /** @description Gift cards type ID */
        giftCardTypeId: number;
        /** @description Gift cards type name */
        giftCardTypeName: string;
    }[];
} & PagedResponse;

export type GetClientsMembershipCardsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Card ID. */
        card_type: number;
...
export type PutClientsMembershipCardsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
...
export type SearchClientsNewsletterEmailResponse = {
...
export type SearchClientsNewsletterSmsResponse = {
    /** @description Customer data. */
    clients: {
        /** @description Customer ID. */
        client_number: number;
...
export type GetClientsPricelistsClientsResponse = {
    result: {
...
export type PutClientsPricelistsClientsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Unique client's number. */
        clientId: number;
...
export type GetClientsPricelistsProductsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        itemsResults: {
            /** @description Id. */
            ...
            itemType: "products" | "producers" | "series" | "categories" | "menuItems";
            /** @description Price. */
            price?: number;
            /** @description Currency ID */
            currencyId?: string;
...
export type PutClientsPricelistsProductsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
...
export type GetClientsPricelistsResponse = {
    /** @description Parameters concerning returned results */
    result: {
...
export type PostClientsPricelistsResponse = {
    /** @description Parameters concerning returned results */
    result: {
        /** @description Individual price list ID. */
        priceListId: number;
...
export type GetClientsPricesActiveCardResponse = {
    cards: {
        /** @description Card ID. */
        id: number;
        /** @description Card type. */
        type: string;
        /** @description Number of active months. */
        month_count: number;
        /** @description Discount group ID. */
        rebate_group: string;
        /** @description Whether to ask about assigning discount group. */
        ask_for_rebate: boolean;
        /** @description Does assigned discount group exist. */
        rebate_exists: boolean;
        /** @description Card number format. */
        number_format: string;
    }[];
};

export type GetClientsPricesDiscountGroupsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Customer group number */
        clientDiscountGroupNumber: number;
        /** @description Percentage value of discount in group# */
        clientDiscountGroupValue: number;
        /** @description Is the group discount summed together - yes - no */
        clientDiscountGroupIsCombined: "yes" | "no";
        /** @description Discount group type - advanced, - simple, - none, - range, - different for groups. */
        clientDiscountGroupType: "advanced" | "simple" | "none" | "range" | "different for groups";
        /** @description Customer group name */
        clientDiscountGroupName: string;
    }[];
} & PagedResponse;

export type GetClientsPricesDiscountsResponse = {
    /** @description Customer discounts. */
    clientDiscounts: {
        /** @description Unique client's number. */
        clientId: number;
        /** @description Are discounts summed together. - yes, - no. */
        clientDiscountIsCombined: "yes" | "no";
        /** @description Discount type: - advanced, - simple, - none, - group. */
        clientDiscountType: "advanced" | "simple" | "none" | "group";
        /** @description percentage discount value. (No data is returned if rebate_type is not "simple"). */
        clientDiscountValue: number;
...
export type PutClientsPricesDiscountsResponse = {
    /** @description List of customers. */
    customers: {
        /** @description Customer ID. */
...
export type GetClientsProfitPointsResponse = {
    /** @description Customer's loyalty points. */
    clientsProfitPointsResults: {
        /** @description Unique client's number. */
        clientId: number;
        /** @description Amount of customer's loyalty points. */
        clientProfitPoints: number;
        /** @description Full history of loyalty points changes. */
        clientProfitPointsHistories: {
            /** @description Number of points in operation. */
            operationPoints: number;
            /** @description Type of operation on points: - pu - Points have been granted in the administration panel, - mu - Points have been subtracted in the administration panel, - cu - Points have been changed in the administration panel, - ao - Points were granted for placing an order, - sp - Points were subtracted for a purchase, - sd - Points were subtracted for paying with them for delivery, - nc - Points granted for newsletter, - oc - Points granted for opinions, - bp - Points for the order have been cancelled, - cp - Points for a product in order have been changed, - so - Payment used to pay for the order, - cc - Change in order, - co - Change of payment in order, - ra - Added for return, - rs - Subtract for return. */
            operationType: string;
            /** @description Operation date. */
            operationDateTime: string;
            /** @description Panel user name. */
...
export type GetClientsProvinceListResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Administrative region code. */
...
export type GetClientsTagsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
...
export type PostClientsTagsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Tag name. */
        tagName: string;
...
export type PutClientsTagsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Tag ID. */
        tagId: number;
...
export type PutConfigVariablesResponse = {
    results: {
        variable: {
            /** @description Key of config value. */
            key: string;
...
export type GetDeliveriesProfilesResponse = {
    /** @description List of all of the delivery profiles defined in the administration panel */
    deliveryProfiles: {
...
export type GetDeliveriesRegionsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        ...
        /** @description Name of delivery profile for retail sales */
        retailProfileName: string;
        /** @description ID of delivery profile for wholesale sales */
        wholesaleProfileId: number;
        /** @description Name of delivery profile for wholesale sales */
        wholesaleProfileName: string;
    }[];
};

export type PostDeliveriesRegionsResponse = {
    /** @description ID of the added region */
    regionId: number;
    /** @description Name of the added region */
    regionName: string;
};

export type GetDiscountsGroupsClientsResponse = {
    result: {
        /** @description Unique client's number. */
        clientId: string[];
    };
...
export type GetDiscountsGroupsResponse = {
    ...
    groups: {
        ...
        groupRebate: number;
        /** */
        groupCombined: "yes" | "no";
        /** @description Discount group type - advanced, - simple, - none, - range, - different for groups. */
        groupType: "advanced" | "simple" | "none" | "range" | "different for groups";
        /** @description Customer group name */
        groupName: string;
    }[];
} & PagedResponse;

export type PostDiscountsGroupsResponse = {
    /** @description Parameters concerning returned results */
    result: {
        /** @description Discount group ID */
...
export type GetEntriesSourcesResponse = {
    results: {
        /** @description Service identifier for the type of entry source. */
        serviceId: number;
...
export type PutMenuSortResponse = {
    /** @description Parameters concerning returned results */
    result: {
        /** @description Shop Id. */
        shop_id: number;
        ...
        recursive?: "y" | "n";
        /** @description Error code. List of error codes: "0" - Operation was successful, "1" - Incorrect shop id, "2" - Incorrect menu id, "3" - Element with indicated ID doesn't exist. */
        faultCode: number;
        /** @description Error description. */
        faultString: string;
    }[];
...
export type PutOrdersCourierResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: boolean;
};
...
export type PostOrdersDocumentsResponse = {
    documentsResults: {
...
export type GetOrdersHandlerResponse = {
...
export type GetOrdersImagesResponse = {
    result: {
        image: {
            /** @description Id */
            id: number;
            ...
            /** @description Author */
            operator: string;
            /** @description Attachment data encoded using the base64 algorithm */
            base64: string;
            /** @description Width */
            width: number;
            /** @description Hight */
...
export type PostOrdersImagesResponse = {
    results: {
        images: {
            /** @description Attachment ID  (Photos) */
            id: number;
            /** @description Information on error that occurred during gate call. */
            errors: {
                /** @description Error code. */
...
export type GetOrdersLabelsResponse = {
...
export type GetOrdersOpinionsRateResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @example 1 */
        id: number;
...
export type PutOrdersProductsSerialNumbersResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Order serial number. */
        orderSerialNumber: number;
...
export type PutOrdersProfitMarginResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Order serial number. */
        orderSerialNumber: number;
...
export type GetOrdersWarehouseResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Stock ID */
        stockId: number;
...
export type PutPackagesResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        /** @description Order ID. */
        orderId: string;
...
export type GetPaymentsFormsResponse = {
    /** @description Parameters concerning returned results */
    result: {
        payment_forms: {
            /** @description Form of payment ID. */
...
export type GetPaymentsProfilesResponse = {
    /** @description List of all of the payment profiles defined in the administration panel */
    paymentProfiles: {
        /** @description Profile ID */
        id: number;
        /** @description Profile name */
...
export type PutProductsGroupsSettingsResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
        productIdent: {
            /** @description Identifier type. */
...
export type GetProductsMarketingPromotionResponse = {
    /** @description Object contains detailed information on result of operation. */
    results: {
...
export type PutReturnsSerialNumberResponse = {
    /** @description Products list. */
    products: {
...
export type GetRmaStatusesResponse = {
    statuses: {
        /** @description Status identifier */
        id: number;
        /** @example description */
...
export type GetSystemServerLoadResponse = {
    /** @description Information about the current server status. Valid values: "overloaded", "normal". */
    serverLoadStatus: "overloaded" | "normal";
};

export type GetSystemServerTimeResponse = {
    /** @description Current server time as a UNIX timestamp (number of seconds since 1 January 1970, 00:00:00). */
    time: number;
};
...
export type GetWarrantiesCountTotalResponse = {
    /** @description Total number of results that meet the request criteria. */
    total_warranties: number;
};

export type PutWarrantiesLanguageDataResponse = {
    lang_data: {
...
export type PutWmsStocksdocumentsDocumentsResponse = {
    /** @description Document identifier. */
    stockDocumentId: number;
};

export type GetWmsStocksdocumentsOpenedDocumentsResponse = {
    /** @description List of documents. */
    documents: {
        /** @description Document identifier. */
        id: number;
        ...
        stockDocumentStatus: "open" | "on_the_way";
        /** @description Delivery on the way. Available values: "1" - yes, "0" - no. */
        deliveryOnTheWay?: boolean;
