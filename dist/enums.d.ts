...
declare enum LANG_IDS {
    ...
    AMHARSKI = "amh",
    ANGIELSKI = "eng",
    ANGIELSKI_STARODAWNY = "ang",
    ANGIELSKI_SREDNIOWIECZNY = "enm",
    ARABSKI = "ara",
    ARAMEJSKI = "arc",
    ARAPAHO = "arp",
    ASTURYJSKI = "ast",
    ...
    KOSRAE = "kos",
    KPELLE = "kpe",
    KREOLE_I_PIDZYNY_OPARTE_NA_JEZYKU_FRANCUSKIM = "cpf",
    KURDYJSKI = "kur",
    LAOTANSKI = "lao",
    LINGALA = "lin",
    LITEWSKI = "lit",
    ...
    MONGOLSKI = "mon",
    NAURU = "nau",
    NDEBELE_POLUDNIOWE = "nbl",
    NDEBELE_POLNOCNE = "nde",
    NEPALSKI = "nep",
    NIEMIECKI = "ger",
    NIEMIECKI_STARODAWNY = "goh",
    NIUEAN = "niu",
    NORDYCKI = "non",
    NORWESKI = "nor",
    NYNORSK_NORWESKI = "nno",
    ORMIANSKI = "arm",
    OROMO = "orm",
    PAPIAMENTO = "pap",
    PASZTO = "pus",
