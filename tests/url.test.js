...
test("getClientsLastPurchased", () => {
    const params = idosell().getClients.clientsIds([123,456,789]).lastPurchased("2023-01-01", 1672704000000).checkParams();
...
test("getReturnsDates", () => {
    const params = idosell().getReturns.dates("2025-01-01", "2025-01-31", 'date_end').checkParams();
    const search = queryfy(params);
